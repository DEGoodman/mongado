      ...
      <main className="mx-auto max-w-5xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <div className="mb-8 rounded-2xl bg-white p-8 shadow-xl sm:p-12">
          ...
          <div className="mb-8 text-center">
            ...
            <p className="mb-2 text-xl text-gray-600">{siteConfig.author.title}</p>
            <p className="text-md text-gray-500">{siteConfig.author.location}</p>
          </div>

          {/* Bio */}
          <div className="prose prose-lg mb-8 max-w-none">
            <p className="mx-auto max-w-3xl text-center leading-relaxed text-gray-700">
          ...
          <div className="mt-8 flex flex-wrap justify-center gap-4">
            <a
              ...
              className="inline-flex items-center gap-2 rounded-lg bg-gray-900 px-6 py-3 text-white shadow-md transition-colors hover:bg-gray-800 hover:shadow-lg"
            >
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 rounded-lg bg-blue-600 px-6 py-3 text-white shadow-md transition-colors hover:bg-blue-700 hover:shadow-lg"
            >
              <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
            ...
            <a
              ...
              className="inline-flex items-center gap-2 rounded-lg bg-gray-100 px-6 py-3 text-gray-900 shadow-md transition-colors hover:bg-gray-200 hover:shadow-lg"
            >
